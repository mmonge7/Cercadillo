...
async function main() {
  ...
  <!-- Main Title -->
  <text x="580" y="240" font-family="Georgia, 'Cinzel', 'Playfair Display', serif" font-size="82" font-weight="bold" fill="url(#sub-text)" letter-spacing="4">MORISCOS</text>
  
  <!-- Subtitle -->
  <text x="580" y="295" font-family="Georgia, 'Cinzel', serif" font-size="28" font-weight="600" fill="url(#gold-text)" letter-spacing="6">MEMORIA &amp; TERRITORIO</text>
  
  <!-- Descriptive tags -->
  <text x="580" y="375" font-family="system-ui, -apple-system, sans-serif" font-size="24" fill="#E8E0CE" opacity="0.95" font-weight="500">Historia · Geografía · Linajes · Tradición</text>
