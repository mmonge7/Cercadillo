...
import { Mail, Github, Linkedin, MessageSquareQuote } from 'lucide-react';
    ...
    <div className="container-editorial py-10 sm:py-16">
      ...
      <div className="mt-12 space-y-10">
        ...
        <article className="card-editorial p-6 sm:p-8">
          ...
          <p className="mt-3 leading-relaxed text-pergamino-muted/80 text-sm sm:text-base">
            Los contenidos se basan en el legado documental del portal <span className="font-semibold text-armuna-light">Morisqueños</span>, en monografías históricas locales sobre geografía, toponimia, economía tradicional y sucesos del pueblo, en legajos de archivos históricos diocesanos y estatales, y en fuentes oficiales como el Instituto Geográfico Nacional (IGN) y el Instituto Nacional de Estadística (INE) para datos de altitud, superficie y población. Puedes consultar el listado completo en el apartado de{' '}
            <button
              type="button"
