...
const muro = [
  {
    id: 'ultima-hora',
    img: '/Cercadillo/images/minas/collage-01-ultima-hora.jpg',
  ...
  {
    id: 'atencion-noticia',
    img: '/Cercadillo/images/minas/collage-02-atencion-noticia.jpg',
  ...
  {
    id: 'medranda-reunion',
    img: '/Cercadillo/images/minas/collage-03-medranda-reunion.jpg',
  ...
  {
    id: 'latoba-fest',
    img: '/Cercadillo/images/minas/collage-04-latoba-fest.jpg',
  ...
  return (
    <div className="container-editorial py-10 sm:py-16">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-noche-border shadow-xl">
        <img
          src="/Cercadillo/images/minas/hero-bg.jpg"
